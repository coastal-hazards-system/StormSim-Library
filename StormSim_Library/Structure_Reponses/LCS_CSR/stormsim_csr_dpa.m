    ...
    for Ntime=1:nTimes_per_LC(NlcS)
        ...
        if repair_lee_now && repair_switch > 0 % Breach
            ...
            [SLee_with_repairs{NlcS}(Ntime),u1p{NlcS}(Ntime)] = ...
                ...
                leeside_slope, seaside_slope, WL{NlcS}(Ntime),Rc{NlcS}(Ntime), Nz{NlcS}(Ntime), ...
        ...
        [SLee_no_repairs{NlcS}(Ntime),u1p{NlcS}(Ntime)] = leeside_armor_stone_damage(SLee_no_repairs_last,...
            Hm0{NlcS}(Ntime),Tm10{NlcS}(Ntime),u1p_last,LDn,...
            leeside_slope, seaside_slope, WL{NlcS}(Ntime),Rc{NlcS}(Ntime),Nz{NlcS}(Ntime),armor_delta,K_ls1,K_ls2,crest_width,crest_elevation,grav, compute_S_submerged,  cutoff_switch, cutoff_delta);
        % Store t-1 Damage State

...
switch struc_type
    ...
    case 3 % Rubblemound
        ...
        % Define Vars To Grab
        vars_2_grab = {'crest_elevation','crest_elevation_lcbw','crest_width','toe_elevation','seaside_slope',...
            'leeside_slope','berm_width','berm_elevation','berm_slope',...
            'armor_delta','lcbw_mass','seaside_mass','leeside_mass','water_density','cem_P',...
            'seaside_design_S','leeside_design_S','seaside_init_S','leeside_init_S',...
